                     ...
                     INT8U    prio)
{
    ...
    if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
        ...
        OS_EXIT_CRITICAL();
        psp = gpRomHookFuncTbl->OSTaskStkInit(task, p_arg, ptos, 0u);             /* Initialize the task's stack         */
                        ...
                        INT16U   opt)
{
    ...
    if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
        ...
        psp = gpRomHookFuncTbl->OSTaskStkInit(task, p_arg, ptos, opt);           /* Initialize the task's stack          */
...
/*$PAGE*/
    ...
    gpRomHookFuncTbl->OSTaskDelHook(ptcb);                                /* Call user defined hook                      */
                    ...
                    OS_TCB  *p_task_data)
{
    ...
    memcpy((INT8U *)p_task_data, (INT8U *)ptcb, sizeof(OS_TCB));
    OS_EXIT_CRITICAL();
    return (OS_ERR_NONE);
}
#endif
...
{
    gpRomHookFuncTbl->OSTaskReturnHook(OSTCBCur);                   /* Call hook to let user decide on what to do        */
